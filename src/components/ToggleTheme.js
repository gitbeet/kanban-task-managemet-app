...
export default function ToggleTheme() {
  ...
  return (
    <div className="rounded-md flex justify-center items-center  py-4 mx-4 space-x-6 bg-neutral-500 dark:bg-primary-200">
      ...
      <div
        ...
        className="cursor-pointer toggle-theme-button bg-primary-600"
      >
        <div
          className={
            darkMode
