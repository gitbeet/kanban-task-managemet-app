...
export default function ToggleTheme() {
  ...
  return (
    <div className={darkMode ? 'border-rounded-sm toggle-theme bg-dark-200' : 'border-radius-sm toggle-theme bg-light-700'}>        
        ...
        <div onClick={toggleDarkMode} className="toggle-theme-button">
            <div className={darkMode ? 'toggle-theme-button-circle circle-right' : 'toggle-theme-button-circle circle-left'}></div>
        </div>
